                ...
                <section className={`${styles.bannerArea} ${styles.relative}`}>
                    <div className='container'>
                        <div className='row d-flex align-items-center justify-content-center'>
                            ...
                            >
                                <h1 style={{ color: `${!theme.light ? '#fff' : '#11161f'}` }}>Code Projects</h1>
                                ...
                                >
                                    ...
                                    >
                                        <div className={`${styles.sectionTitle} text-white`}>
                                            <h2 style={{ color: `${!theme.light ? '#fff' : '#11161f'}` }}>{code.title}</h2>
                                        </div>
                                        <div className='text-white'>
                                            ...
                                            <div>
                                                <p style={{ color: `${!theme.light ? '#fff' : '#11161f'}` }}>{code.description && code.description}</p>
                                            </div>
                                            <div className={`${!theme.light ? styles.links : styles.linksLight}`}>
                                                {
                                                    code.slug &&
                                                    <Link href={`/projects/code/${code.slug?.current}`}>
                                                        <button className={`${styles.btn} btn btn-sm`}>See more <b>• • •</b></button>
                                                    </Link>
                                                }
                                                <div>
                                                    {code.link && (
